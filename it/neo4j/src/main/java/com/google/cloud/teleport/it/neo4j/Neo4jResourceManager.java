...
import static com.google.cloud.teleport.it.neo4j.Neo4jResourceManagerUtils.generateDatabaseName;
...
public class Neo4jResourceManager extends TestContainerResourceManager<Neo4jContainer<?>>
  ...
  public static final class Builder
    ...
    private Builder(String testId) {
      super(testId);
      this.containerImageName = DEFAULT_NEO4J_CONTAINER_NAME;
      this.containerImageTag = DEFAULT_NEO4J_CONTAINER_TAG;
    }
